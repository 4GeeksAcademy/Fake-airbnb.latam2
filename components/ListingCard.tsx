...
export const ListingCard = ({ alojamiento }: ListingCardProps) => {
  return (
    <article className="rounded-2xl border border-[#DDDDDD] bg-white p-3">
      <div className="mb-3 flex h-48 items-center justify-center rounded-xl bg-gradient-to-br from-[#F7F7F7] to-[#EBEBEB] text-xs text-[#6A6A6A] md:h-52">
        {alojamiento.imagePlaceholder}
      </div>
